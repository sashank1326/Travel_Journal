...
export const analyzeBlogContent = async (req, res) => {
  ...
  6. **Hotel Suggestions** (Provide at least 2 hotel options in **Budget**, **Mid-Range**, and **Luxury** categories, along with their price ranges) – Suggest hotel options based on the destination’s general characteristics ,make sure you dont change letters while giving **Budget**, **Mid-Range**, and **Luxury**.
  7. **Estimated Cost** (Estimate the total cost for a one-week trip, split by Budget, Mid-Range, and Luxury categories, including transportation, accommodation, food, etc.) – Provide detailed breakdowns for each category (Transportation, Accommodation(Specify like you are giving for one week), Food, Activities/Miscellaneous), along with the total estimated cost for Budget, Mid-Range, and Luxury categories. Make sure to provide the cost values in **Indian Rupees (₹) if it is an Indian place**,make sure you dont change letters while giving **Budget**, **Mid-Range**, and **Luxury**.
